...
fs.readFile(moduleJsonPath, 'utf8', (err, data) => {
    ...
    moduleJson.manifest = `https://github.com/gambit07/gambitsIdentificationInhibitor/releases/latest/download/module.json`;
    moduleJson.download = `https://github.com/gambit07/gambitsIdentificationInhibitor/releases/download/${version}/module.zip`;
